...
const HomeScreen = () => {
  ...
  useEffect(() => {
    ...
    setIsAdmin(user.email == 'dobri@dobri.com');
          ...
          !isAdmin && (
            <View style={styles.singleButtonContainer}>
              <Pressable
                ...
                onPress={() => navigation.navigate("AllOrders")}
              >
                <Text style={[styles.actionButtonText, styles.singleButtonText]}>Orders</Text>
              </Pressable>
            </View>
          )
        }
...
const styles = StyleSheet.create({
  ...
  singleButton: {
    ...
    paddingHorizontal: 20,
    borderRadius: 7,
    flexGrow: 1, // Ovo omogućava dugmetu da zauzme celu širinu
  },
  singleButtonText: {
    fontSize: 16,
    fontWeight: "600",
